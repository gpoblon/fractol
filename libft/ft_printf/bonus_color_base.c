...
/*   Updated: 2017/01/06 17:14:33 by gpoblon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_sub_get_color_code(t_info *i, int n, char *color, int len)
{
...
int			ft_get_color_code(t_info *i)
{
	...
	if (ft_strncmp("{eoc}", i->printstr + i->i, 5) == 0)
		ft_sub_get_color_code(i, 5, "\033[0m", 4);
	else if (ft_strncmp("{cyan}", i->printstr + i->i, 6) == 0)
		ft_sub_get_color_code(i, 6, "\x1b[36m", 5);
	else if (ft_strncmp("{black}", i->printstr + i->i, 7) == 0)
		ft_sub_get_color_code(i, 7, "\033[30m", 5);
	else if (ft_strncmp("{yellow}", i->printstr + i->i, 8) == 0)
		ft_sub_get_color_code(i, 8, "\033[33m", 5);
	else if (ft_strncmp("{red}", i->printstr + i->i, 5) == 0)
		ft_sub_get_color_code(i, 5, "\033[31m", 5);
	else if (ft_strncmp("{white}", i->printstr + i->i, 7) == 0)
		ft_sub_get_color_code(i, 7, "\033[37m", 5);
	else if (ft_strncmp("{green}", i->printstr + i->i, 7) == 0)
		ft_sub_get_color_code(i, 7, "\033[32m", 5);
	else
		ft_get_color_code_2(i);
